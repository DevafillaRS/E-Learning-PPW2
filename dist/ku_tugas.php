...
if (isset($_POST['submit'])) {
    ...
    $path = "Tugas Mahasiswa/";
    $filePath = $path . $fileName;
    $result = move_uploaded_file($tmpName, $filePath);

    if ($result) {

        $sql = "INSERT INTO tmahasiswa (mahasiswa, kelas, judul, ftugas, tanggal) 
            VALUE ('$mahasiswa', '$kelas', '$judul', '$fileName', '$tanggal')";

        $query = mysqli_query($koneksi, $sql);
        if ($query) {
            header('location: ku_tugas.php');
        } else {
            echo "gagal submit";
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <section class="widget">
                            <header>
                                <h5>
                                    <span class="fw-semi-bold">Pengumpulan</span>
                                </h5>
                            </header>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-12">
                                            <form action="" method="POST" enctype="multipart/form-data">
                                                ...
                                                <button type="submit" name="submit" class="btn btn-warning">Upload Tugas</button>
                                            </form>
                                        </div>
                                    </div>
