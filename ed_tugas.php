...
if (isset($_POST['submit'])) {
    ...
    if (true) {
        ...
        $sqlUpdate = "UPDATE tugas SET dosen='$dosen', judul='$judul', deskripsi='$deskripsi', deadline='$deadline' WHERE id=$id";

        $queryUpdate = mysqli_query($koneksi, $sqlUpdate);
        if ($queryUpdate) {
            header('location: ed_tugas.php?id='.$id);
        } else {
            echo "gagal update";
                        ...
                        <div class="col-lg-6 col-md-12">
                            <form action="" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>Dosen</label>
                                    <input type="text" class="form-control" name="dosen" value="<?= $tugas['dosen'] ?>">
                                </div>
                                <div class="form-group">
                                    <label>Judul</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" name="deskripsi"><?= $tugas['deskripsi'] ?></textarea>
                                </div>
                                <!-- <div class="form-group">
                                    <label>Tugas</label>
                                    <input type="file" class="form-control" name="tugas" value="<?= $tugas['tugas'] ?>">
                                </div> -->
                                <div class="form-group">
