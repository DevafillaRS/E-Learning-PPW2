...
if (isset($_POST['submit'])) {
    ...
    if (true) {
        ...
        $sqlUpdate = "UPDATE ujian SET dosen='$dosen', judul='$judul', deskripsi='$deskripsi', deadline='$deadline' WHERE id=$id";

        $queryUpdate = mysqli_query($koneksi, $sqlUpdate);
        if ($queryUpdate) {
            header('location: ed_ujian.php?id='.$id);
        } else {
            echo "gagal update";
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>Judul</label>
                                    <input type="text" class="form-control" name="judul" value="<?= $ujian['judul'] ?>">
                                </div>
                                <div class="form-group">
                                    <label>Deskripsi</label>
                                    <textarea type="text" class="form-control" name="deskripsi"><?= $ujian['deskripsi'] ?></textarea>
                                </div>
                                <!-- <div class="form-group">
                                    <label>Ujian</label>
                                    <input type="file" class="form-control" name="ujian" value="<?= $ujian['tugas'] ?>">
                                </div> -->
                                <div class="form-group">
                                    <label>Deadline</label>
                                    <input type="date" class="form-control" name="deadline" value="<?= $ujian['deadline'] ?>">
                                </div>

                                <button type="submit" name="submit" class="btn btn-primary">Simpan Edit</button>
                            </form>
                        </div>
                    </div>
