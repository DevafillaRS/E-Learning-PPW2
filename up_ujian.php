<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        $fileName = $_FILES['ujian']['name'];
        $fileName = time().$fileName;
        $tmpName = $_FILES['ujian']['tmp_name'];
        $path = "Upload Ujian/";
        ...
        if ($result) {
            ...
            $sql = "INSERT INTO ujian (dosen, judul, deskripsi, ujian, deadline) 
            VALUE ('$dosen', '$judul', '$deskripsi', '$fileName', '$deadline')";
    
            $query = mysqli_query($koneksi, $sql);
            if($query){
                header('location: up_ujian.php');
            } else {
                echo "gagal submit";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800"> Ujian E-Learning</h1>
                    <br>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                  <label>Ujian</label>
                                  <input type="file" class="form-control" name="ujian">
                                </div>
                                <div class="form-group">
                                ...
                                <button type="submit" name="submit" class="btn btn-primary">Upload Ujian</button>
                              </form>
                        </div>                        
                    </div>
