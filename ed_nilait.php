...
if (isset($_POST['submit'])) {
    ...
    if (true) {
        ...
        $sqlUpdate = "UPDATE tmahasiswa SET nilai='$nilai' WHERE id=$id";

        $queryUpdate = mysqli_query($koneksi, $sqlUpdate);
        if ($queryUpdate) {
            header('location: dad_tugas.php?id=' . $id);
        } else {
            echo "gagal update";
                        ...
                        <div class="col-lg-6 col-md-12">
                            <form action="" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>Nilai</label>
                                    <input type="text" class="form-control" name="nilai" value="<?= $tmahasiswa['nilai'] ?>">
                                </div>
