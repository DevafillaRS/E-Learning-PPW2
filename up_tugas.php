<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        if ($result) {
            ...
            $sql = "INSERT INTO tugas (dosen, judul, deskripsi, tugas, deadline) 
            VALUE ('$dosen', '$judul', '$deskripsi', '$fileName', '$deadline')";
    
            $query = mysqli_query($koneksi, $sql);
            if($query){
                header('location: up_tugas.php');
            } else {
                echo "gagal submit";
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <button type="submit" name="submit" class="btn btn-primary">Upload Tugas</button>
                              </form>
                        </div>                        
                    </div>
