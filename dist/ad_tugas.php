<?php
include '../koneksi.php';
$result = mysqli_query($koneksi, "SELECT * FROM tmahasiswa ORDER BY id ASC");
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <section class="widget">
                            <header>
                                <h5>
                                    <span class="fw-semi-bold">Kumpulkan</span>
                                </h5>
                            </header>
                            <div class="widget-body">
                                <table class="mb-0 table dashboard-table">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $i = 1;
                                        while ($tmahasiswa = mysqli_fetch_array($result)) { ?>
                                            <tr>
                                                <td><?= $i ?></td>
                                                <td><?= $tmahasiswa['mahasiswa'] ?></td>
                                                <td><?= $tmahasiswa['kelas'] ?></td>
                                                <td><?= $tmahasiswa['judul'] ?></td>
                                                <td><?= $tmahasiswa['ftugas'] ?></td>
                                                <td><?= $tmahasiswa['nilai'] ?></td>
                                                <td><?= $tmahasiswa['tanggal'] ?></td>
                                                <td>
                                                    <a href="http://localhost/PENS/UAS/E-Learning/dist/Tugas Mahasiswa/<?= $tmahasiswa['ftugas'] ?>" class="badge badge-success">Download</a>
                                                    <a href="ed_tugasm.php?id=<?= $tmahasiswa['id'] ?>" class="badge badge-warning">Edit</a>
                                                    <a href="k_tugasm.php?id=<?=$tmahasiswa['id']?>" class="badge badge-danger">Hapus</a>
                                                </td>
                                            </tr>
